package info.coderman.dhtcrawler.server;
...
import info.coderman.dhtcrawler.structure.Node;
import info.coderman.dhtcrawler.structure.Queue;
import info.coderman.dhtcrawler.util.ByteUtil;
import info.coderman.dhtcrawler.util.NodeIdUtil;
...
public class DHTServer extends Thread {
    ...
    private void responseGetPeers(InetSocketAddress address, byte[] t, byte[] info_hash) {
        ...
        LOG.info("info_hash[GetPeers] : " + address.toString() + " - " + ByteUtil.byteArrayToHex(info_hash));
    }
    ...
    private void responseAnnouncePeer(InetSocketAddress address, byte[] t, byte[] info_hash, int port, byte[] token) {
    	...
    	LOG.info("info_hash[AnnouncePeer] : " + address.toString() + " - " + ByteUtil.byteArrayToHex(info_hash));
    }
