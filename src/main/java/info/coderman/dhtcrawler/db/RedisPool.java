package info.coderman.dhtcrawler.db;
...
public class RedisPool {  
    ...
    private static String ADDR_ARRAY = "114.115.211.123";     
...
//    private static String AUTH = "";  
    ...
    private static void initialPool(){  
        try {  
            ...
            jedisPool = new JedisPool(config, ADDR_ARRAY.split(",")[0], PORT, TIMEOUT,"95685#441");  
        } catch (Exception e) {  
            ...
            try{  
                ...
                config.setMaxWaitMillis(MAX_WAIT);  
                config.setTestOnBorrow(TEST_ON_BORROW);  
                jedisPool = new JedisPool(config, ADDR_ARRAY.split(",")[1], PORT, TIMEOUT,"95685#441");  
            }catch(Exception e2){  
