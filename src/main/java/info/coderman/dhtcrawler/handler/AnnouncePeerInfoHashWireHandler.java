...
import info.coderman.dhtcrawler.structure.Info;
import info.coderman.dhtcrawler.structure.SubFile;
import info.coderman.dhtcrawler.structure.Torrent;
import info.coderman.dhtcrawler.util.ByteUtil;
import info.coderman.dhtcrawler.util.ExtensionUtil;
import info.coderman.dhtcrawler.util.StringUtil;
...
public class AnnouncePeerInfoHashWireHandler implements IInfoHashHandler {
	...
	private String decode_utf8(String encoding, Map<String, Object> map, String key) throws UnsupportedEncodingException {
		...
		return new String((byte[]) map.get(key),"UTF-8");
	}
	...
	private String decode_utf8_2(String encoding, Map<String, Object> map, String key) throws UnsupportedEncodingException {
		...
		return new String(((List<byte[]>) map.get(key )).get(0),"UTF-8");
	}
